...
def aiReferenceRepair(newCode, appName, referenceCode, fileTask):
    prompt = f"""
...
def aiMergeCode(task, appName, baseCode, newCode):
    prompt = f"""
...
def aiGenCode(fileTask, newTask, appName, baseCode):
    prompt = f"""
