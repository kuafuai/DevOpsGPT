...
def getFrontendText():
    ...
    return {
        ...
        "industry_it_services": _("IT Services"),
        "industry_manufacturing": _("Manufacturing"),
        "industry_wholesale_retail": _("Wholesale and Retail"),
        "industry_lifestyle_services": _("Lifestyle Services"),
        "industry_culture_sports_entertainment": _("Culture/Sports/Entertainment"),
        "industry_construction_real_estate": _("Construction and Real Estate"),
        "industry_education": _("Education"),
        "industry_transportation": _("Transportation"),
        "industry_healthcare_beauty": _("Healthcare and Beauty"),
        "industry_government": _("Government"),
        "industry_finance": _("Finance"),
        "industry_energy": _("Energy"),
        "industry_agriculture": _("Agriculture, Forestry, Fishing, and Animal Husbandry"),
        "industry_other": _("Other Industries"),
